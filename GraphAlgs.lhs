...
2003.1.8  Neal Nelson & Sherri Shulman

----WARNING WARNING---- This module is only a skeleton and will not work as is.

> module GraphAlgsSimple where
> import GraphS  -- Change this name as needed to work with your Graph module
...
-- 5. 
isSimpleCycle :: Ord a => Graph a -> Path a -> Bool
...
first node adjacent to the second node? Assume cycles cannot have repeated
nodes (a simple cycle), although authors differ on this.
